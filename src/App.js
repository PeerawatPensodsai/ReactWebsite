      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.wrapper}>
          ...
          <Typography variant="h5" className={classes.littleSpace} color="primary">
              Lorem ipsu, dolor sit amet, consectetur adipscing elit. Aenean sodales coungue tristique. Cras non pretium sem. Duis interdum lorem sit amet ligula pretium, sed rutrum urna semper.Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Phasellus egestas gravida ullamcorper.
          </Typography>
        </div>
        ...
        <div className={classes.bigSpace}>
          ...
          {//<CustomBtn txt="Hello EveryNyan~~~ Welcome to my first React Website"/>
          }
